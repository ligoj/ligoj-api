...
public class HeaderHttpResponseCallbackTest {
	...
	public void onResponseNoHeader() throws Exception {
		...
		Assert.assertFalse(new HeaderHttpResponseCallback("header").onResponse(new CurlRequest("GET", "", ""), response));
	}
	...
	public void onResponse() throws Exception {
		...
		Assert.assertTrue(new HeaderHttpResponseCallback("header").onResponse(new CurlRequest("GET", "", ""), response));
	}
}
