...
public interface IUserRepository {
	 ...
	 *                       groups. When <code>null</code>, there is no constraint.
	 ...
	 *
	 * @param user        The user to update.
	 * @param password    The user current password. When <code>null</code>, a new temporary password will be generated
